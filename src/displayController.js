...
const displayController = (function () {
  ...
  (function createTask() {
    ...
    submitBtn.addEventListener("click", (event) => {
      ...
      projectsArray.storeTask(
        newTask(title, description, dueDate, priority, project, taskCount),
        project,
      );
  ...
  (function saveInput() {
    tasks.addEventListener("click", (event) => {
      if (event.target.classList[0] === "save") {
        ...
        const editedDueDateInput =
          document.querySelector(`#editeddueDate`).value;
        const editedDescriptionInput =
          document.querySelector(`#editeddescription`).value;
        const editedPriorityInput =
          document.querySelector(`#editedpriority`).value;
        const editedProjectInput =
          document.querySelector(`#editedproject`).value;
        ...
        const description = inputsListObjects(
